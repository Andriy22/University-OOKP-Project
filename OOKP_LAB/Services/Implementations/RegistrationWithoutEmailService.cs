...
{
    public class RegistrationWithoutEmailService : IRegistrationService
    {

        private readonly UserManager<User> userManager;
        private readonly SignInManager<User> signInManager;

        public RegistrationWithoutEmailService(UserManager<User> userManager, SignInManager<User> signInManager)
        {
